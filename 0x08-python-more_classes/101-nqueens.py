...
It determines all the possible solutions to placing N
...
Attributes:
    ...
    solutions (list): list of lists containing the solutions.

Solutions are represented in this format [[r, c], [r, c], [r, c], [r, c]]
where `r` and `c` represent the column and row, respectively, where a
